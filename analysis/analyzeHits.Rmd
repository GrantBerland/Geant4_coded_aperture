...
data = pd.read_csv("../data/hit_decayTest5.csv", names=['E','det','i','j','x0','y0','z0']);
data.info()
...
#data = pd.read_csv("../data/hit_decayTest2.csv", names=['E','det','i','j','x0','y0','z0']);
#data = pd.read_csv("../data/hit_decayTest3.csv", names=['E','det','i','j','x0','y0','z0']);
data = pd.read_csv("../data/hit_decayTest6.csv", names=['E','det','i','j','x0','y0','z0']);
...
MF  = 1
rec_image1 = convolve(avg_image - MF*np.mean(avg_image), decoder, mode='full', method='direct')
rec_image1[rec_image1 < 0] = 0

decoder[decoder == -1] = -0.7059;
rec_image2 = convolve(avg_image, decoder, mode='full', method='direct')
