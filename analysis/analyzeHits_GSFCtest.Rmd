...
for name in GSFC_data_blanca.keys():
    ...
    xe = he1[1][0:-1] + np.diff(he2[1])/2

    yp = photonQDE * hp1[0]/mc_factor
    xp = hp1[1][0:-1] + np.diff(hp2[1])/2
...
for name in GSFC_data_blanca.keys():
    ...
    he1=np.histogram(GSFC_data_blanca[name].E[GSFC_data_blanca[name].p == 'e-'], bins=bins_mod);
    hp1=np.histogram(GSFC_data_blanca[name].E[GSFC_data_blanca[name].p == 'gamma'], bins=bins_mod);
    ...
    he2=np.histogram(GSFC_data_blanca1mmAl[name].E[GSFC_data_blanca1mmAl[name].p == 'e-'], bins=bins_mod) 
    hp2=np.histogram(GSFC_data_blanca1mmAl[name].E[GSFC_data_blanca1mmAl[name].p == 'gamma'], bins=bins_mod);
